...
function AdminsTable(props)
{
    ...
    useEffect(() => {
        setData(searchText.length === 0 ? admins : _.filter(admins, item => (item.firstName.toLowerCase()+" "+item.lastName.toLowerCase()).includes(searchText.toLowerCase())))
    }, [admins, searchText]);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="w-52" component="th" scope="row" padding="none">
                                            {n.avatar ? (
                                                <img className="w-full block rounded" src={FuseUtils.getUrl()+n.avatar.url} alt={n.name}/>
                                            ) : (
                                                <img className="w-full block rounded" src="assets/images/avatars/images.png" alt={n.name}/>
                                            )}
                                        </TableCell>
