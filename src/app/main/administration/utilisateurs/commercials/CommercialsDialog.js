...
import { Button, Dialog, DialogActions, DialogContent, Icon, IconButton, Typography, Toolbar, AppBar, DialogTitle, DialogContentText, InputAdornment, Avatar, CircularProgress, Chip } from '@material-ui/core';
            ...
            <AppBar position="static" elevation={1}>
                ...
                <div className="flex flex-col items-center justify-center pb-24">
                    ...
                    {form.parent1 && (
                        ...
                        <Chip
                            avatar={<Avatar alt="Natacha" src={form.parent1.avatar? FuseUtils.getUrl()+form.parent1.avatar.url :"assets/images/avatars/images.png"} />}
                            label={'Admin: '+form.parent1.firstName+' '+form.parent1.lastName}
                            variant="outlined"
                            color="secondary"
                        />
