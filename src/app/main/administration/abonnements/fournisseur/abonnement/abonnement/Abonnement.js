                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/admin/offres/abonnement" color="inherit">
                                    ...
                                    <>
                                        <Grid container spacing={3} className="">
                                            <Grid item xs={12} sm={6}>
                                                <Typography className="mb-16" variant="h6">1- Fournisseurs & Offres</Typography>

                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                                <Typography className="mb-16" variant="h6">Récapitulatif de votre abonnement</Typography>
                                                ...
                                                <Grid item xs={12} sm={4}>
                                                    <div className="flex">
                                                        <TextFieldFormsy
                                                            ...
                                                            type="text"
                                                            name="fullname"
                                                            value={fournisseur.civilite + ' ' + fournisseur.firstName + ' ' + fournisseur.lastName}
                                                            label="Nom complet"
                                                            InputProps={{
                                                                readOnly: true,
                                                            }}
                                            ...
                                            <Grid container spacing={3} className="mb-5">
                                                ...
                                                <Grid item xs={12} sm={8}>
                                                    ...
                                                    <TextFieldFormsy
                                                        ...
                                                        name="secteur"
                                                        label="Produits"
                                                        value={fournisseur.categories ? _.join(_.map(fournisseur.categories, 'name'), ', ') : ''}
                                                        fullWidth
                                                        multiline
                                                        rows="3"
                                                        InputProps={{
                                            ...
                                            <Grid container spacing={3} className="mb-5">
                                                ...
                                                <Grid item xs={12} sm={4}>
                                                    <TextFieldFormsy
                                                        ...
                                                        name="pays"
                                                        id="pays"
                                                        value={fournisseur.pays ? fournisseur.pays.name : ''}
                                                        label="Pays"
                                                        InputProps={{
                                                            readOnly: true,
                                                        }}
                                                ...
                                                <Grid item xs={12} sm={4}>
                                                    <TextFieldFormsy
                                                        ...
                                                        name="ville"
                                                        id="ville"
                                                        value={fournisseur.ville ? fournisseur.ville.name : ''}
                                                        label="Ville"
                                                        InputProps={{
                                                            readOnly: true,
                                                        }}
