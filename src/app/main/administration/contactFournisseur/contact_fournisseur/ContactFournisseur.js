...
function ContactFournisseur(props) {
    ...
    const contactFournisseur = useSelector(({ contactsFournisseurApp }) => contactsFournisseurApp.contactFournisseur);
    ...
    useEffect(() => {
        if (
            ...
            (contactFournisseur.data && form && contactFournisseur.data.id !== form.id)
        ) {
                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/contact_fournisseur" color="inherit">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                                            <Typography className="text-16 sm:text-20 truncate">
                                                {form.fournisseur ? 'Message pour le fournisseur: ' + form.fournisseur.societe : ''}
                                            </Typography>
                                        </FuseAnimate>
                                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
...
export default withReducer('contactsFournisseurApp', reducer)(ContactFournisseur);
