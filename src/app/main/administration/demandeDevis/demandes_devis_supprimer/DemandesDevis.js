...
function DemandesDevis() {
    ...
    useEffect(() => {
        dispatch(Actions.getDemandesDeleted(parametres));
        return () => {
    ...
    return (
        <>
            <Helmet>
                <title>Demandes devis supprimées | Les Achats Industriels</title>
...
export default withReducer('demandesDevistraitesApp', reducer)(DemandesDevis);
