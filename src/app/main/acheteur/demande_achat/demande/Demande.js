...
function Demande(props) {
    ...
    return (
        <>
            <Helmet>
                <title>{demandeId === 'new' ? 'Nouvelle demande' : 'Edit demande'} | Les Achats Industriels</title>
                            ...
                            <div className="flex flex-1 w-full items-center justify-between">
...

                                {
                                    ...
                                    >
                                        ...
                                        <span className="flex sm:hidden"><Icon>save</Icon></span>
                                        {demande.loading && <CircularProgress size={24} className={classes.buttonProgress} />}
                                    </Button>
                                    {
                                        demandeId === 'new' &&
                                        ...
                                        >
                                            ...
                                            <span className="flex sm:hidden"><Icon>repeat</Icon></span>
                                ...
                                {tabValue === 0 &&
                                    (
                                        <Formsy
                                            ...
                                            <Typography variant="caption" className="font-bold flex items-center" color="secondary">
                                                IMPORTANT : Pour que votre demande soit diffusée aux fournisseurs désignés, veuillez sélectionner le bon produit.
                                                    </Typography>
                                            ...
                                            <Grid container spacing={3} className="mt-4">
                                                <Grid item xs={12} sm={10} >
                                                    ...
                                                    </Button>
                                                    {
                                                        ...
                                                        >
                                                            <span className="hidden sm:flex">Sauvegarder et ajouter nouvelle demande</span>
                                                            <span className="flex sm:hidden"><Icon>save</Icon> et <Icon>repeat</Icon></span>
