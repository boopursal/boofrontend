    ...
    return (
         <div className="flex flex-1 items-center justify-between p-8 sm:p-24">
                ...
                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                    <Button onClick={ev => dispatch(Actions.openNewCommandesDialog())} className="whitespace-no-wrap" variant="contained">
                        <span className="hidden sm:flex">Commander des jetons</span>
