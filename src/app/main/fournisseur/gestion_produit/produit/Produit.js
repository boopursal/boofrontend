...
function Produit(props) {
    ...
    useEffect(() => {
        if (produit.error && (produit.error.reference || produit.error.description || produit.error.pu || produit.error.secteur || produit.error.sousSecteurs)) {
            {
    ...
    function handleSubmit(form) {
        ...
        if (produitId === 'new') {
            dispatch(Actions.saveProduit(form));
        }
        else {

            dispatch(Actions.putProduit(form, form.id));
        }
