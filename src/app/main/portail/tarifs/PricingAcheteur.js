...
import { Button, Card, CardContent, Typography, Grid, ListItem, List, ListItemText, Divider, Icon } from '@material-ui/core';
...
const useStyles = makeStyles(theme => ({
    header: {
        height: 300,
        background: 'linear-gradient(to right, ' + theme.palette.secondary.dark + ' 0%, ' + theme.palette.secondary.main + ' 100%)',
        color: 'white'
    },
    badge: {
            ...
            <div className="-mt-160 mb-24">
                ...
                <div className="w-full max-w-2xl mx-auto">
                            ...
                            <Grid item xs={6} sm={6} md={8} container spacing={1}>
                                ...
                                <Grid item xs={12} sm={6} md={6} container>
                                    <Grid item xs={12} style={{
                                        background: "linear-gradient(to top left, #feb2b2 10%, #feb2b2 30%, #e53e3e 60%, #e53e3e 60%)",
                                        ...
                                        <List className={classes.root}>
                                            ...
                                            <ListItem classes={{ root: "h-60 sm:h-56 text-center" }} >
                                                <ListItemText
                                                    ...
                                                    primary={<Icon style={{ color: green[500] }}>check_circle</Icon>}
                    ...
                    <div className="flex flex-col mt-8">
                        ...
                        <Typography variant="caption" >* Les Fournisseurs qui ont acheté votre Profil pour vous contacter.</Typography>
                        <Typography variant="caption" >** Le compte anonyme vous libère de gérer vos achats et les fournisseurs ne sauront pas votre identité. Un pourcentage payant sera défini en commun accord pour chaque RFQ.</Typography>
                        <Typography variant="caption" >*** Sous Compte acheteur vous permet d'ajouter vos collègues ou collaborateurs pour plus d'efficacité.</Typography>
