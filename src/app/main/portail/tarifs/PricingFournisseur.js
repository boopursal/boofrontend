                    ...
                    <FuseAnimate duration={400} delay={800}>
                        <Grid container >
                            ...
                            <Grid item xs={6} sm={6} md={8} container spacing={1}>
                                ...
                                <Grid item xs={12} sm={6} md={3} className="flex hidden sm:block md:block lg:block ">

                                    <Grid item xs={12} style={{
                                        background: "linear-gradient(to top left, #9ae6b4 10%, #9ae6b4 30%, #38a169 60%, #38a169 60%)",
                                        borderRadius: "20px 20px 0 0",
                                ...
                                <Grid item xs={12} sm={6} md={3} className="flex hidden sm:hidden md:block lg:block ">

                                    <Grid item xs={12} style={{
                                        background: "linear-gradient(to top left, #90cdf4 10%, #90cdf4 30%, #3182ce 60%, #3182ce 60%)",
                                        borderRadius: "20px 20px 0 0",
                                ...
                                <Grid item xs={12} sm={6} md={3} className="flex hidden sm:hidden md:block lg:block ">
                                    ...
                                    <Grid item xs={12} style={{
                                        background: "linear-gradient(to top left, #faf089 10%, #faf089 30%, #d69e2e 60%, #d69e2e 60%)",
                                        borderRadius: "20px 20px 0 0",
