        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll, 'min-h-md')}>
            {
                ...
                <Helmet>
                    <title>{activites.sousSecteur.name + ' | Les Achats Industriels'}</title>
                    <meta name="description" content={activites.sousSecteur.name + ' | Les Achats Industriels'} />
                    <meta property="og:title" content={activites.sousSecteur.name} />
                    <meta property="og:description" content={activites.sousSecteur.name + ' | Les Achats Industriels'} />
                </Helmet>
            }
            <div
                        ...
                        <div className="p-16 pl-32">
                            {
                                ...
                                <Button component={Link} size="small" to={`/annuaire-entreprises/${activites.sousSecteur.secteur.id}-${activites.sousSecteur.secteur.slug}`}
                                        ...
                                        (
                                            <React.Fragment>
                                                <Grid item sm={6} xs={12}>
                                                    <List dense={true} >
                                                        {
                                                            activites.data && activites.data.map((categorie, i) => (
                                                                (i + 1) % 2 !== 0 && (
